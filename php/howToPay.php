                ...
                <div id="field">
                    <div id="home" class="top-image-area">
                        ...
                        <table>
                            ...
                            <th colspan="2">PayPalで</th>
                            <tr>
                                <td colspan="2">PayPal決済</td>
                            </tr>
                            <th colspan="2">後払いで</th>
                            <tr>
                                <td colspan="2">後払いPaidy</td>
                            </tr>
                            <th colspan="2">振込で</th>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2">ゆうちょ銀行</td>
                            </tr>
                            <th colspan="2">コンビニで</th>
                            <tr>
                                <td colspan="2">セブンイレブン</td>
                            </tr>
                            <tr>
                                <td colspan="2">ファミリーマート</td>
                            </tr>
                            <tr>
                                <td colspan="2">ローソン</td>
                            </tr>
                            <tr>
                                <td colspan="2">その他のコンビニ</td>
                            </tr>
                        </table>
                        <br>
                    </div>
