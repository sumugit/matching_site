            ...
            <div id="contenar">
                <div id="field">
                    <div id="home" class="top-image-area">
                        ...
                        <div class="box30">
                            <div class="box-title">新型コロナウイルスの感染症対策について</div>
                            <p>いつもご利用いただきありがとうございます。<br>
                                <br>
                                新型コロナウイルスの感染に関する報道等で、<br>
                                <br>
                                ・手洗い、うがいの徹底<br>
                                ・咳エチケット<br>
                                ・人混みを避ける<br>
                                <br>
                                お客様におかれましては、上記内容をすでに意識されていることと思います。<br>
                                緊急事態宣言が出ている地域に関しましては日程を変更してお会いになられてください。<br>
                                それ以外の地域の方もご注意ください。<br>
                                <br>
                                また、新型コロナウイルスの流行状況を鑑み、一部掲示板のジャンル名を変更させて頂きました。<br>
                                <br>
                                最新の情報は『厚生労働省HP』よりご確認ください。<br>
                                <br>
                                なお、マッチングナビで実施しているお客様対応、管理・監視体制については、今のところ通常通りとなっております。</p>
                        </div>
                        <br>
                    </div>
                </div>
