            ...
            <div id="contenar">
                <div id="field">
                    <div id="home" class="top-image-area">
                        ...
                        <div class="box30">
                            <div class="box-title">24時間365日 万全のサポート対応</div>
                            <p>「○○の仕方がわからない…<br>
                                「ポイントを追加したいんだけど…」<br>
                                そんなお客様の声にお応えするために、専任スタッフが24時間体制でサポートを行っていますので、アフターフォローも万全です。<br>
                                些細なご質問でもお気軽にお問い合わせください。</p>
                        </div>
                        <br>
                        <a href="contact.php" class="btn-square">お問い合わせはこちら</a>
                        <br>
                    </div>
                </div>
            </div>
