            ...
            <div id="contenar">
                <div id="field">
                    <div id="home" class="top-image-area">
                        ...
                        <div class="box30">
                            <div class="box-title">会員規約の適用</div>
                            <p>1. この｢会員規約｣は、株式会社Electricity and Communications（以下「弊社」と言います）が提供するマッチングナビ（以下「本サービス」といいます）の利用に関して適用されます。<br>
                                2. 本規約とは別に弊社が定める諸規定は、本規約の一部を構成するものとします。<br>
                                3. 本規約の規定と前項の規定の内容が異なるまたは矛盾する場合は、本規約が優先して適用されるものとします。<br>
                                4. 本規約と他の規定が異なるまたは矛盾する場合以外は、本規約と他の規定が重複して適用されるものとします。<br>
                                5. 弊社が本ｻｰﾋﾞｽの会員に対して発する本規約第５条規定の「弊社からの通知」は、本規約の一部を構成するものとします。</p>
                        </div>
                        <br>
                        <div class="box30">
                            <div class="box-title">規約の変更</div>
                            <p>弊社は、コミュニティサイト運営業者として、各種法令および善良な社会通念、反社会勢力の排除を厳格に遵守することを社是とし、
                                18歳に満たない児童（高校生を含みます）のサイト利用防止を最重点課題として運営することとします。</p>
                        </div>
                        <br>
                        <div class="box30">
                            <div class="box-title">弊社の基本方針</div>
                            <p>弊社は、コミュニティサイト運営業者として、各種法令および善良な社会通念、反社会勢力の排除を厳格に遵守することを社是とし、
                                18歳に満たない児童（高校生を含みます）のサイト利用防止を最重点課題として運営することとします。</p>
                        </div>
                        <br>
