                                    ...
                                    if (count($fp1) == count($fp2)) {
                                        ...
                                        while (!feof($fp2)) {
                                            ...
                                            if (strcmp($user[2], $_SESSION['sex']) != 0 && $user[2] != "") {
                                                //URLパラメータ生成
                                                print '<a href="userProfile.php?id=' . $content[0] . '"><div class="item"><img src = ' . $content[1] . ' width="128" height="128" alt=""><p><b>' . $content[5] . '　' . $content[4] . '</b></p><p class="textOverflowTest3">' . $content[2] . '</p></div></a>';
                                            }
                                        }
                                    }
                                    //登録ファイルを閉じる
